...
// Test: Invalid case (no straight - all duplicates)
resetRadioOptions();
checkForStraights([1, 1, 4, 4, 4]); // No consecutive sequence
assert.isTrue(scoreInputs[5].disabled === false); // Final radio button should be enabled
assert.strictEqual(scoreInputs[5].value, "0"); // Score should be 0
assert.strictEqual(scoreSpans[5].innerText, ", score = 0");

// Test: Incomplete small straight
resetRadioOptions();
checkForStraights([1, 3, 4, 5, 5]); // Incomplete sequence
assert.isTrue(scoreInputs[5].disabled === false); // Final radio button should be enabled
assert.strictEqual(scoreInputs[5].value, "0"); // Score should be 0
assert.strictEqual(scoreSpans[5].innerText, ", score = 0");
...
resetRadioOptions();
checkForStraights([1, 2, 4, 6, 6]); // No consecutive sequence
assert.isTrue(scoreInputs[5].disabled === false); // Final radio button should be enabled
assert.strictEqual(scoreInputs[5].value, "0"); // Score should be 0
assert.strictEqual(scoreSpans[5].innerText, ", score = 0");

// Test: Valid small straight
resetRadioOptions();
checkForStraights([4, 2, 3, 5, 6]); // Includes consecutive numbers for small straight
assert.isFalse(scoreInputs[3].disabled); // Small straight radio button should be enabled
assert.strictEqual(scoreInputs[3].value, "30");
assert.strictEqual(scoreSpans[3].innerText, ", score = 30");

// Test: Valid large straight
resetRadioOptions();
checkForStraights([1, 2, 3, 4, 5]); // Perfect large straight
assert.isFalse(scoreInputs[4].disabled); // Large straight radio button should be enabled
assert.strictEqual(scoreInputs[4].value, "40");
assert.strictEqual(scoreSpans[4].innerText, ", score = 40");
```
